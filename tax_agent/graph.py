...
When answering:
1. Focus on the 3-5 most important tax consequences only
2. Distinguish civil vs. criminal exposure briefly
3. Name the main agencies involved (IRS, DOJ Tax Division, FinCEN) when relevant
4. Note company vs. executive liability in one short sentence

Keep the response under 150 words.
End with a one-sentence educational-use disclaimer.
"""
